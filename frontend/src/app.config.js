const _config = {
    ...
    prod: {
        todoapi:process.env.REACT_APP_TODOAPI || "digitalocean", google_client_id: process.env.REACT_APP_CLIENT_ID || "423125049963-vnhlm59vvirdjsquu0efhqvq5u91orks.apps.googleusercontent.com",
